...
![Lamp Automation](bedside-light/lamp-automation.png)
...
![Music Automation](bedside-light/music-automation.png)
...
![Turnoff Automation](bedside-light/turnoff-automation.png)
...
![Turnoff Remote Control](bedside-light/turnoff-remote.png)

And then in IoT MQTT Panel we can set up some controls for the lamp:

![iotmqttpanel](bedside-light/iotmqttpanel.jpg)
...
![MQTT Controls](bedside-light/mqtt-controls.png)

### Conclusion

And we are done! The light and music will start at 22:00 every day. The light will fade out when you click the button in the Android App and the music will stop 30 minutes later. The whole flow can be [found here](bedside-light/flows.json).
